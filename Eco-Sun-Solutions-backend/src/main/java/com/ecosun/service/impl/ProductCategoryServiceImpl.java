...
public class ProductCategoryServiceImpl implements ProductCategoryService {
	...
	public List<ProductCategoryDTO> getAllProductCategories() {
		...
		return categories.stream().map(category -> modelMapper.map(category, ProductCategoryDTO.class))
	...
	@Override
	public List<ProductCategoryResponseDTO> searchElementByCategoryName(String categoryName) {

		List<ProductCategory> list = productCategoryRepository.findByCategoryNameContaining(categoryName);

		// Map each ProductCategory to ProductCategoryResponseDTO
		List<ProductCategoryResponseDTO> searchedList = list.stream()
